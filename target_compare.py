...
sc_path="./"
cp_out_path="./dependencies/EszterGulyasBSc/chembl-pipeline-main/output/chembl_29/"
cp_in_path="./dependencies/EszterGulyasBSc/chembl-pipeline-main/input/"
...
# Selecting all human targets with at least 5 positive and negative samples in all folds (This criteria is in SparseChem to compute AUC)
n=5
...
# Matching targets by their chEMBLID
...
auc_multispecies_filtered=auc_multispecies[all_mask].values
...
conn = sqlite3.connect(cp_in_path + "chembl_29_sqlite/chembl_29.db")
